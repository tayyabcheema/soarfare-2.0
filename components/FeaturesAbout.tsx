...
const FeaturesAbout: React.FC = () => {
  return (
    <section className="w-[90%] xl:w-[85%] 2xl:w-[80%] max-w-8xl mx-auto lg:px-4 py-8">
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16 xl:gap-20 2xl:gap-2 lg:pt-32 lg:pb-32">
        ...
        {/* Right side - Two Images (shows first on mobile) */}
        <div className="relative w-full lg:w-[45%] xl:w-[40%] 2xl:w-[50%] order-1 lg:order-2">
            ...
            <div className="relative">
              ...
              <div className="lg:w-full w-[80%] mx-auto">
                <Image
                  ...
                  width={500}
                  height={400}
                  className="w-full h-auto rounded-lg object-cover lg:max-w-[550px]"
                  priority
                />
              </div>
              
              {/* Smaller overlapping image */}
              <div className="absolute -bottom-10  lg:-left-16 -left-0 w-4/5 max-w-[450px]">
                <Image
                  src="/about.jpg"
                  alt="Happy travelers"
                  width={600}
        ...
        <div className="w-full lg:w-[55%] xl:w-[60%] 2xl:w-[50%] flex items-center order-2 lg:order-1">
