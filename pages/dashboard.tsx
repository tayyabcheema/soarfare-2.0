...
const Dashboard = () => {
  ...
  const renderIcon = (iconType: string, isActive = false) => {
    ...
    switch (iconType) {
      ...
      case "creditcard":
        return (
          <svg className={className} fill="currentColor" viewBox="0 0 24 24">
            <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM20 8H4V6h16v2zm0 10H4v-6h16v6z" />
          </svg>
        );
      default:
        return null;
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "subscription":
        return <PricingSection showHeading={false} />;
      default:
        return null;
    }
  };
